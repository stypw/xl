import { ApplicationRef, Component, ElementRef, HostBinding, Injectable, Input } from "@angular/core";
import { Call, SetValue } from "@stypw/xl/core";
...
export class XlLoadingComponent {
  ...
  ngOnInit(){
    this.globalLoadingService.createGlobalLoading();
  }
